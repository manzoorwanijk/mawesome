...
📚 **Full documentation** is on the [docs site](https://mawesome.dev/dependency-audit/) — [concepts](https://mawesome.dev/dependency-audit/concepts/), the [CLI](https://mawesome.dev/dependency-audit/cli/) and [API](https://mawesome.dev/dependency-audit/api/) references, the [output format](https://mawesome.dev/dependency-audit/output-format/) (text grammar + `--json` schema), a [findings & notices](https://mawesome.dev/dependency-audit/findings/) reference, the [resolution model](https://mawesome.dev/dependency-audit/resolution/), [limitations & troubleshooting](https://mawesome.dev/dependency-audit/limitations/), [security](https://mawesome.dev/dependency-audit/security/), and how it [compares to publint/attw](https://mawesome.dev/dependency-audit/comparison/) — or read the source in [`docs/`](./docs/).
